...
class StockWindow(object):
    ...
    def setupUi(self, CurrentWindow):
        ...
        CurrentWindow.resize(1097, 1050)
        ...
        self.buy_edit.setGeometry(QtCore.QRect(150, 1000, 131, 31))
        ...
        self.background_label.setGeometry(QtCore.QRect(30, 660, 1051, 315))
