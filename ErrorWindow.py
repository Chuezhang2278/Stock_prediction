...
class ErrorWindow(object):
    def setupUi(self, CurrentWindow):
        ...
        CurrentWindow.resize(482, 412)
        CurrentWindow.setMinimumSize(QtCore.QSize(0, 0))
        CurrentWindow.setMaximumSize(QtCore.QSize(99999, 99999))
        font = QtGui.QFont()
        ...
        self.close_button.setGeometry(QtCore.QRect(180, 350, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
    ...
    def retranslateUi(self, CurrentWindow):
        ...
        self.line3.setText(QtWidgets.QApplication.translate("CurrentWindow", "Password must be at least 9 characters, no spaces", None, -1))
